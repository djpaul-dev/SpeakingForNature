...
public class NatureGame extends PApplet {
  ...
  public void draw() {
    ...
    for (int i = 0; i < objects.size(); i++) {
      if (objects.get(i) instanceof SkipButton) {
  ...
  public void growTree() {
    ...
    switch (SCORE) {
      case 2:
        ...
        break;
      case 3:
        Tree tree3 = new Tree(225, 392, "images" + File.separator + "tree" + SCORE + ".png");
        objects.add(tree3);
        break;
      case 4:
        Tree tree4 = new Tree(225, 340, "images" + File.separator + "tree" + SCORE + ".png");
        objects.add(tree4);
        break;
      case 5:
        Tree tree5 = new Tree(240, 305, "images" + File.separator + "tree" + SCORE + ".png");
        objects.add(tree5);
        break;
    }
  }
